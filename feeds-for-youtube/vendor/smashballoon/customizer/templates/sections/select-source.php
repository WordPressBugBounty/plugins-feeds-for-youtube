<div class="sbc-feedtypes-ctn sbc-fs sb-box-shadow" v-if="viewsActive.selectedFeedSection == 'selectSource' && !iscustomizerScreen">
    <div class="sbc-select-source-content">
        ...
        <input class="sbc-input" type="text" :aria-label="sourcesScreenText[selectedFeed].placeholder" :placeholder="sourcesScreenText[selectedFeed].placeholder" v-model="selectedFeedModel[selectedFeed]">
    ...
    <div class="sbc-select-source-footer" v-if="sourcesScreenText[selectedFeed].footerText">
        ...
        <div class="sbc-select-source-footer-right">
            ...
            <button type="button" class="sbc-feedflow-manual-connect" @click.prevent.default="showFeedSourceManualConnect()">Cannot Connect? Try connecting manually</button>
        </div>
    </div>
</div>