    ...
    <div class="sb-customizer-sidebar-sec1 sbc-yt-fs">
        <div class="sb-customizer-sidebar-tab-ctn sbc-yt-fs" v-if="customizerScreens.activeSection == null"
            ...
            <button type="button" class="sb-customizer-sidebar-tab" v-for="tab in customizerSidebarBuilder"
                 ...
                 @keydown.end.prevent="handleCustomizerTabKeydown($event, 'end')"><span class="sb-standard-p sb-bold">{{tab.heading}}</span></button>
        </div>
        <div class="sb-customizer-sidebar-sec-ctn sbc-yt-fs"
            ...
            <div v-for="(section, sectionId) in customizerSidebarBuilder[customizerScreens.activeTab].sections">
                <button type="button" class="sb-customizer-sidebar-sec-el sbc-yt-fs" v-if="!section.isHeader" @click.prevent.default="switchCustomizerSection(sectionId, section)">
        ...
        <div class="sbc-yt-fs" v-if="customizerScreens.activeSection != null">
            <div class="sb-customizer-sidebar-header sbc-yt-fs" :data-separator="customizerScreens.activeSectionData.separator ? customizerScreens.activeSectionData.separator : ''">
                <div class="sb-customizer-sidebar-breadcrumb sbc-yt-fs">
                    <button type="button" class="sb-customizer-sidebar-breadcrumb-link" @click.prevent.default="switchCustomizerTab(customizerScreens.activeTab)">
                        <svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                    ...
                    <button type="button" v-if="customizerScreens.parentActiveSection != null" @click.prevent.default="switchCustomizerSection(customizerScreens.parentActiveSection, customizerScreens.parentActiveSectionData)" class="sb-customizer-sidebar-breadcrumb-link sbi-child-breadcrumb">
                        <svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                            <path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
                        </svg>{{customizerScreens.parentActiveSectionData.heading}}
                    </button>
                    <button type="button" v-if="customizerScreens.parentActiveSection == 'customize_videos' && nestedStylingSection.includes(customizerScreens.activeSection)" @click.prevent.default="backToPostElements()" class="sb-customizer-sidebar-breadcrumb-link sbi-child-breadcrumb">
                        <svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                            <path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
                        </svg>Elements
                    </button>
                    <button type="button" v-if="customizerScreens.activeSection == 'lightbox_call_to_action'" @click.prevent.default="backToLightboxExperience()" class="sb-customizer-sidebar-breadcrumb-link sbi-child-breadcrumb">
                        <svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                            <path d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z" fill="#434960"/>
            ...
            <div class="sb-customizer-sidebar-controls-ctn sbc-yt-fs">
                ...
                <button type="button" class="sbc-sidebar-video-sections-link sb-control-elem-ctn sbc-yt-fs" v-if="customizerScreens.activeSection == 'customize_feedlayout'" @click.prevent.default="switchToVideosSection">
