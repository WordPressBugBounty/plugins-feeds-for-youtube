<script type="text/x-template" id="sb-confirm-dialog-component">
	<div class="sb-dialog-ctn sb-fs-boss sbc-center-boss" v-if="dialogBoxElement.active">
		<div class="sb-dialog-popup sbc-fb-popup-inside sbc-delete-feed-popup" role="dialog" aria-modal="true" :aria-label="dialogBoxElement.heading" tabindex="-1">
			<button type="button" class="sbc-popup-cls" aria-label="<?php esc_attr_e('Close', 'feeds-for-youtube'); ?>" @click.prevent.default="closeConfirmDialog">
