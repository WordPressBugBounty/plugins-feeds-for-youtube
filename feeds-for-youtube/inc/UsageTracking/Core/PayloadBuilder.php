<?php
/**
 * Builds the full usage report payload for YouTube Feeds.
 *
...
class PayloadBuilder {
	...
	/**
	 * List the active plugins on the site (network-activated included).
	 *
	 * @return array
	 */
