...
<div class="sb_youtube_header <?php echo esc_attr( $size_class ); ?>"<?php echo $header_style_attr; ?> <?php echo $header_display_condition;?>>
    <a href="<?php echo esc_url( $permalink ); ?>" target="_blank" rel="noopener" aria-label="<?php echo esc_attr( sprintf( __( '%s on YouTube', 'feeds-for-youtube' ), $channel_title ) ); ?>" title="@<?php echo esc_attr( $channel_title ); ?>" class="sby_header_link" data-channel-description="<?php echo $settings['showdescription'] ? 'visible' : 'hidden'; ?>">
